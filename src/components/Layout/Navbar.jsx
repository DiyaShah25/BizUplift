                ...
                <div className="container flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {isAuthenticated ? (
                            ...
                            <Link to="/auth" className="hidden md:flex items-center gap-2 text-sm font-bold px-4 py-2 rounded-full text-white transition-all hover:opacity-90 hover:scale-105" style={{ background: 'var(--btn-gradient)' }}>
            ...
            <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden border-t shadow-lg" style={{ background: navBg, borderColor: navBorder }}>
                <div className="flex items-center justify-around py-2">
                    {[
                        ...
                        { to: isAuthenticated ? getDashboardLink() : '/auth', icon: <User className="w-5 h-5" />, label: 'Profile' },
                    ].map(item => (
