...
const Checkout = () => {
    ...
    const { addOrder, addNotification } = useData();
    ...
    const handlePlaceOrder = async () => {
        ...
        const order = addOrder({ customerId: currentUser.id, items: cartItems.map(i => ({ productId: i.productId, name: i.name, quantity: i.quantity, price: i.price, image: i.image })), total, paymentMethod, address });
        setOrderId(order.id);
        clearCart();
