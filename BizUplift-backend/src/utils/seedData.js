...
const seed = async () => {
    try {
        ...
        const PRODUCTS_DATA = [
            ...
            { name: 'Brass Puja Thali Set',                  sellerId: sellerKala._id,   sellerName: 'KalaKraft',    festival: 'Diwali',   category: 'Decoration',         images: ['https://images.unsplash.com/photo-1620807664364-77acecd33d96?auto=format&fit=crop&q=80&w=800'], mrp: 1499, price: 999,  minPrice: 850,  maxDiscount: 20, stock: 45,  rating: 4.7, reviews: 89,  negotiable: true,  tags: ['diwali','puja','thali','brass'],          featured: true  },
            { name: 'Marigold Flower Garland (5ft)',         sellerId: sellerKala._id,   sellerName: 'KalaKraft',    festival: 'Diwali',   category: 'Decoration',         images: ['https://images.unsplash.com/photo-1605629124403-516d7249a463?auto=format&fit=crop&q=80&w=800'], mrp: 399,  price: 199,  minPrice: 150,  maxDiscount: 30, stock: 200, rating: 4.5, reviews: 120, negotiable: true,  tags: ['decoration','flowers','toran'],           featured: false },
            // Holi
            { name: 'Organic Herbal Gulal (Pack of 5)',      sellerId: sellerMithai._id, sellerName: 'MithaiBhandar',festival: 'Holi',     category: 'Decoration',         images: ['https://images.unsplash.com/photo-1615967008748-0382d556391d?auto=format&fit=crop&q=80&w=800','https://images.unsplash.com/photo-1583094179374-60c042302384?auto=format&fit=crop&q=80&w=800'], mrp: 499,  price: 399,  minPrice: 350,  maxDiscount: 15, stock: 300, rating: 4.8, reviews: 445, negotiable: true,  tags: ['holi','colors','gulal','organic'],        featured: true  },
            { name: 'Traditional Thandai Mix (200g)',        sellerId: sellerMithai._id, sellerName: 'MithaiBhandar',festival: 'Holi',     category: 'Food & Sweets',      images: ['https://images.unsplash.com/photo-1709420601321-ea5064e650ab?auto=format&fit=crop&q=80&w=800'], mrp: 350,  price: 299,  minPrice: 250,  maxDiscount: 10, stock: 100, rating: 4.7, reviews: 234, negotiable: false, tags: ['holi','drink','thandai'],                featured: true  },
            { name: 'White Cotton Kurta for Holi',           sellerId: sellerPunjab._id, sellerName: 'PunjabDiHaat', festival: 'Holi',     category: 'Clothing',           images: ['https://plus.unsplash.com/premium_photo-1682096349312-d81b8359288e?auto=format&fit=crop&q=80&w=800'], mrp: 999,  price: 699,  minPrice: 599,  maxDiscount: 20, stock: 150, rating: 4.4, reviews: 189, negotiable: true,  tags: ['holi','clothing','kurta','white'],        featured: false },
            // Navratri
            { name: 'Embroidered Chaniya Choli Set',         sellerId: sellerKerala._id, sellerName: 'KeralaKrafts', festival: 'Navratri', category: 'Clothing',           images: ['https://images.unsplash.com/photo-1596001407335-512a80479717?auto=format&fit=crop&q=80&w=800'], mrp: 4500, price: 3200, minPrice: 2800, maxDiscount: 20, stock: 25,  rating: 4.9, reviews: 95,  negotiable: true,  tags: ['navratri','garba','lehenga','clothing'],  featured: true  },
            { name: 'Decorative Dandiya Sticks (Pair)',      sellerId: sellerKala._id,   sellerName: 'KalaKraft',    festival: 'Navratri', category: 'Decoration',         images: ['https://images.unsplash.com/photo-1614713781216-b51e06fe9266?auto=format&fit=crop&q=80&w=800'], mrp: 299,  price: 199,  minPrice: 150,  maxDiscount: 15, stock: 200, rating: 4.6, reviews: 178, negotiable: true,  tags: ['navratri','dandiya','dance','prop'],      featured: false },
            // Eid
            { name: 'Authentic Sheer Khurma Mix (1kg)',      sellerId: sellerMithai._id, sellerName: 'MithaiBhandar',festival: 'Eid',      category: 'Food & Sweets',      images: ['https://plus.unsplash.com/premium_photo-1695123927643-989278bd44aa?auto=format&fit=crop&q=80&w=800'], mrp: 599,  price: 499,  minPrice: 450,  maxDiscount: 10, stock: 60,  rating: 4.8, reviews: 167, negotiable: false, tags: ['eid','sweets','dessert','seviyan'],       featured: true  },
            { name: 'Crystal Attar Perfume Bottle',          sellerId: sellerKala._id,   sellerName: 'KalaKraft',    festival: 'Eid',      category: 'Decoration',         images: ['https://images.unsplash.com/photo-1585250462024-6f5df5802a8b?auto=format&fit=crop&q=80&w=800'], mrp: 999,  price: 799,  minPrice: 700,  maxDiscount: 15, stock: 40,  rating: 4.7, reviews: 88,  negotiable: true,  tags: ['eid','attar','perfume','gift'],           featured: false },
            // Rakhi
            { name: 'Handcrafted Zardosi Rakhi',             sellerId: sellerKala._id,   sellerName: 'KalaKraft',    festival: 'Rakhi',    category: 'Gifts',              images: ['https://images.unsplash.com/photo-1628151015968-3a4429e9ef04?auto=format&fit=crop&q=80&w=800'], mrp: 299,  price: 199,  minPrice: 150,  maxDiscount: 20, stock: 500, rating: 4.8, reviews: 654, negotiable: true,  tags: ['rakhi','raksha bandhan','brother','gift'],featured: true  },
            { name: 'Assorted Mithai Gift Box',              sellerId: sellerMithai._id, sellerName: 'MithaiBhandar',festival: 'Rakhi',    category: 'Food & Sweets',      images: ['https://images.unsplash.com/photo-1601303516668-52467d36d390?auto=format&fit=crop&q=80&w=800'], mrp: 699,  price: 599,  minPrice: 500,  maxDiscount: 10, stock: 100, rating: 4.6, reviews: 210, negotiable: true,  tags: ['rakhi','sweets','gift'],                 featured: false },
            // Onam
            { name: 'Traditional Kasavu Saree',              sellerId: sellerKerala._id, sellerName: 'KeralaKrafts', festival: 'Onam',     category: 'Clothing',           images: ['https://images.unsplash.com/photo-1617627143750-d86bc21e42bb?auto=format&fit=crop&q=80&w=800'], mrp: 2499, price: 1899, minPrice: 1600, maxDiscount: 25, stock: 50,  rating: 4.9, reviews: 134, negotiable: true,  tags: ['onam','saree','kerala','clothing'],       featured: true  },
            { name: 'Kerala Banana Chips (Freshly Fried)',   sellerId: sellerKerala._id, sellerName: 'KeralaKrafts', festival: 'Onam',     category: 'Food & Sweets',      images: ['https://images.unsplash.com/photo-1606449629199-72c0c73229b1?auto=format&fit=crop&q=80&w=800'], mrp: 399,  price: 299,  minPrice: 250,  maxDiscount: 15, stock: 200, rating: 4.7, reviews: 320, negotiable: false, tags: ['onam','chips','snacks'],                 featured: false },
            // Christmas
            { name: 'Handmade Pine Cone Wreath',             sellerId: sellerKerala._id, sellerName: 'KeralaKrafts', festival: 'Christmas',category: 'Decoration',         images: ['https://images.unsplash.com/photo-1545048702-79362596cdc9?auto=format&fit=crop&q=80&w=800'], mrp: 1299, price: 999,  minPrice: 800,  maxDiscount: 20, stock: 30,  rating: 4.8, reviews: 112, negotiable: true,  tags: ['christmas','wreath','decoration'],        featured: true  },
            { name: 'Rich Plum Cake (Traditional)',          sellerId: sellerKerala._id, sellerName: 'KeralaKrafts', festival: 'Christmas',category: 'Food & Sweets',      images: ['https://images.unsplash.com/photo-1639587400508-32386992d9d0?auto=format&fit=crop&q=80&w=800'], mrp: 899,  price: 699,  minPrice: 600,  maxDiscount: 15, stock: 100, rating: 4.9, reviews: 287, negotiable: false, tags: ['christmas','cake','sweets'],              featured: true  },
            // Lohri / Pongal
            { name: 'Til-Gud Ladoo (Sesame Jaggery Balls)', sellerId: sellerMithai._id, sellerName: 'MithaiBhandar',festival: 'Lohri',    category: 'Food & Sweets',      images: ['https://images.unsplash.com/photo-1547849208-e87f54c99731?auto=format&fit=crop&q=80&w=800'], mrp: 349,  price: 279,  minPrice: 240,  maxDiscount: 10, stock: 120, rating: 4.6, reviews: 198, negotiable: false, tags: ['lohri','pongal','sweets','til'],          featured: false },
            { name: 'Phulkari Dupatta (Hand-Embroidered)',   sellerId: sellerPunjab._id, sellerName: 'PunjabDiHaat', festival: 'Lohri',    category: 'Clothing',           images: ['https://images.unsplash.com/photo-1601633534571-066345dc3ce2?auto=format&fit=crop&q=80&w=800'], mrp: 1599, price: 1199, minPrice: 1000, maxDiscount: 20, stock: 40,  rating: 4.8, reviews: 145, negotiable: true,  tags: ['lohri','clothing','dupatta','phulkari'],  featured: true  },
            { name: 'Earthen Pongal Pot Set',                sellerId: sellerKala._id,   sellerName: 'KalaKraft',    festival: 'Pongal',   category: 'Decoration',         images: ['https://images.unsplash.com/photo-1543167120-d7d8e8745c11?auto=format&fit=crop&q=80&w=800'], mrp: 699,  price: 499,  minPrice: 400,  maxDiscount: 25, stock: 60,  rating: 4.5, reviews: 89,  negotiable: true,  tags: ['pongal','pot','decoration'],              featured: false },
            // Dussehra
            { name: 'Hand-Painted Ravana Mask',              sellerId: sellerKala._id,   sellerName: 'KalaKraft',    festival: 'Dussehra', category: 'Decoration',         images: ['https://images.unsplash.com/photo-1634560756779-11ba2182df56?auto=format&fit=crop&q=80&w=800'], mrp: 499,  price: 349,  minPrice: 300,  maxDiscount: 20, stock: 50,  rating: 4.4, reviews: 45,  negotiable: true,  tags: ['dussehra','mask','craft'],               featured: false },
            // All year
            { name: 'Blue Pottery Vase (Jaipur)',            sellerId: sellerKala._id,   sellerName: 'KalaKraft',    festival: 'All',      category: 'Handicrafts',        images: ['https://images.unsplash.com/photo-1610701596007-11502861dcfa?auto=format&fit=crop&q=80&w=800'], mrp: 1299, price: 899,  minPrice: 800,  maxDiscount: 25, stock: 30,  rating: 4.7, reviews: 156, negotiable: true,  tags: ['decor','handicraft','pottery'],           featured: false },
            { name: 'Assorted Scented Candles (Set of 3)',   sellerId: sellerKala._id,   sellerName: 'KalaKraft',    festival: 'All',      category: 'Candles & Diyas',    images: ['https://images.unsplash.com/photo-1602826646961-00aa6ae9c946?auto=format&fit=crop&q=80&w=800'], mrp: 799,  price: 599,  minPrice: 500,  maxDiscount: 20, stock: 100, rating: 4.8, reviews: 267, negotiable: true,  tags: ['candles','gift','decor'],                featured: false },
            { name: 'Hand-Woven Area Rug',                   sellerId: sellerPunjab._id, sellerName: 'PunjabDiHaat', festival: 'All',      category: 'Handicrafts',        images: ['https://images.unsplash.com/photo-1596288647047-97d54b834458?auto=format&fit=crop&q=80&w=800'], mrp: 2500, price: 1799, minPrice: 1500, maxDiscount: 25, stock: 20,  rating: 4.5, reviews: 89,  negotiable: true,  tags: ['rug','decor','home'],                     featured: false },
        ];
